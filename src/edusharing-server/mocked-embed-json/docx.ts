export const docxEmbedJson = {
  ...
  node: {
    ...
    remote: null,
    content: {
      url: 'https://repository.staging.cloud.schulcampus-rlp.de/edu-sharing/components/render/fcf32661-266f-44e4-a487-325bef5e78a3',
      hash: '-1350582801',
      version: '1.1',
    },
    license: {
    ...
    ref: {
      repo: 'local',
      id: 'fcf32661-266f-44e4-a487-325bef5e78a3',
      archived: false,
      isHomeRepo: true,
    },
    parent: {
    ...
    name: 'Lars Test Docx.docx',
    title: null,
    metadataset: 'mds',
    repositoryType: 'ALFRESCO',
    createdAt: '2024-03-18T15:41:01Z',
    createdBy: {
      profile: null,
      firstName: 'sso',
      lastName: 'schuelereins',
    ...
    modifiedAt: '2024-03-18T15:41:50Z',
    modifiedBy: {
      profile: null,
      firstName: 'sso',
      lastName: 'schuelereins',
    ...
    downloadUrl:
      'https://repository.staging.cloud.schulcampus-rlp.de/edu-sharing/eduservlet/download?nodeId=fcf32661-266f-44e4-a487-325bef5e78a3',
    properties: {
      'ccm:original': ['fcf32661-266f-44e4-a487-325bef5e78a3'],
      'cm:created': ['1710776461808'],
      'virtual:commentcount': ['0'],
      'ccm:metadatacontributer_creatorVCARD_ORG': [''],
      'cclom:size': ['25195'],
      'cclom:version': ['1.1'],
      'virtual:usagecount': ['1'],
      'sys:node-uuid': ['fcf32661-266f-44e4-a487-325bef5e78a3'],
      ...
      'cm:modifiedISO8601': ['2024-03-18T15:41:50.425Z'],
      'ccm:metadatacontributer_creatorVCARD_REGION': [''],
      'sys:node-dbid': ['49717136'],
      ...
      'virtual:permalink': [
        'https://repository.staging.cloud.schulcampus-rlp.de/edu-sharing/components/render/fcf32661-266f-44e4-a487-325bef5e78a3/1.1',
      ],
      ...
      'cclom:location': ['ccrep://local/fcf32661-266f-44e4-a487-325bef5e78a3'],
    ...
    preview: {
      ...
      mimetype: null,
      data: null,
      url: 'https://repository.staging.cloud.schulcampus-rlp.de/edu-sharing/preview?nodeId=fcf32661-266f-44e4-a487-325bef5e78a3&storeProtocol=workspace&storeId=SpacesStore&dontcache=1711366873995',
      width: null,
      height: null,
    },
    iconURL:
