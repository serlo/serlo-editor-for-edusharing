  ...
  return (
    ...
    >
      {props.renderIntoSettings(
        <div>
          <label htmlFor="transformationTarget">{equationStrings.mode}:</label>{' '}
          <select
          ...
          >
            <option value={TransformationTarget.Equation}>
              {equationStrings.transformationOfEquations}
            </option>
            <option value={TransformationTarget.Term}>
              {equationStrings.transformationOfTerms}
            </option>
          </select>
        </div>
      )}
                                ...
                                config: {
                                  placeholder:
                                    ...
                                    transformationTarget ===
                                      ...
                                      ? equationStrings.combineLikeTerms
                                      : equationStrings.explanation,
                                },
                              })}
                            </td>
                          </ExplanationTr>
        ...
        <FirstExplanationTr>
          ...
          <td colSpan={3}>
            {state.firstExplanation.render({
              config: {
                placeholder: equationStrings.firstExplanation,
              },
            })}
          </td>
        </FirstExplanationTr>
      ...
      {transformationTarget === TransformationTarget.Equation && (
        ...
        >
          <InlineMath
            ...
            placeholder={
              row === 0 ? '3x+1' : `[${equationStrings.leftHandSide}]`
            }
            state={state.left}
        ...
        <InlineMath
          ...
          placeholder={
            row === 0
              ...
              ? `[${equationStrings.term}]`
              : `[${equationStrings.rightHandSide}]`
          }
          state={state.right}
      ...
      {transformationTarget === TransformationTarget.Equation && (
        ...
        >
          ...
          <InlineMath
            ...
            placeholder={
              row === 0
                ? equationStrings.transformationExample
                : `[${equationStrings.transformation}]`
            }
